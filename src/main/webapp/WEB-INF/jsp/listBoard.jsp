...
<body>
	...
	<div style="width:800px;margin:0 auto;height:50px;position:relative;">
		<button type="button" class="btn btn-danger btn-sm" onclick="location.href='logList.do'" style="position:absolute;right:0;">로그보기</button>
	</div>
	<div align="center">
...
<!-- 페이징 끝  -->
		...
		<button type="button" class="btn btn-primary"
			onclick="location.href='insertBoardForm.do'">등록</button>
